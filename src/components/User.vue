        ...
        <div class="m_right">
            ...
            <table border="0" class="mon_tab" style="width:870px; margin-bottom:20px;" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td width="60%">用户名：<span style="color:#555555;">{{name}}</span></td>
              </tr>
              <tr>
                <td>电&nbsp; &nbsp; 话：<span style="color:#555555;">{{tel}}</span></td>
...
<script>
    ...
    mounted(){
        ...
        axios.post('http://localhost/03kj/blog/public/api/me',{

...
<div class="top">
    <div class="logo"><a href="http://localhost:8080/#/Index"><img src="" /></a></div>
    <div class="search">
    	<form>
            ...
            <div class="leftNav">
                <ul>      
                    <li v-for = "value in msg">
                        ...
                        <div class="zj">
                            <div class="zj_l">
                                <div class="zj_l_c" v-for="data in value.data">
                                    <h2>{{data.name}}</h2>
                                    <a href="#" v-for="sons in data.data">{{sons.name}}</a>                                   
                                </div>                                
                            </div>
                            <div class="zj_r">
        ...
        <div class="fresh_mid">
        	<ul>
            	<li v-for="name in value">
                	...
                	<div  class="name"><a href="http://localhost:8080/#/shop">{{name[0]}}</a></div>
                    
                    <div class="price">
                    	<font>￥<span>198.00</span></font> &nbsp; 26R
                    </div>
                    <router-link :to="{path:  '/shop', query:{aId:name[1]}}">
            ...
            <div id="feature1">
                <div id="block1">
                    <div id="botton-scroll1">
                        <ul class="featureUL">
                            <li class="featureBox" v-for = "value in info">
                                <div class="box">
                                    <div class="imgbg">
...
export default {
  data () {
    ...
    mounted () {
          axios
          .get('http://localhost/03kj/blog/public/index')
          .then(response => (
		  ...
		  axios
          .get('http://localhost/03kj/blog/public/sort')
		  .then(response => (
        ...
        axios
        .get('http://localhost/03kj/blog/public/floor')
        .then(response => (
          this.lou = response.data
          ))
          .catch(function (error) {
              console.log(error);
        });

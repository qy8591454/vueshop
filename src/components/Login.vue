      ...
      <div class="log_c">
        <form>
          <table border="0" style="width:370px; font-size:14px; margin-top:30px;" cellspacing="0" cellpadding="0">
            ...
            <tr height="60">
              <td>&nbsp;</td>
              <td><input type="submit" value="登录" class="log_btn" @click="doLogin" /></td>
            </tr>
          </table>
        </form>
      </div>
    ...
    export default {
        ...
        methods : {
          doLogin () {
            ...
            axios.post('http://localhost/03kj/blog/public/api/login',{
            ...
            .then(res => {
              if (res.data.token_type=='error') {
                ...
                console.log(this.useinfo.username);
                localStorage.setItem("name",this.useinfo.username);
